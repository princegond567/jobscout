          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <h1 className="text-2xl font-semibold gradient-text tracking-tight">Companies</h1>
              </div>
              <p className="text-sm text-(--fg-muted) ml-11">Manage your registered companies</p>
            </div>
            <button onClick={() => navigate("/admin/companies/create")} className="btn-primary px-5 py-2.5 text-sm rounded-xl flex items-center gap-2">
